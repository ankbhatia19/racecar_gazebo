...
#include "racecar_hardware/racecar_gazebo.hpp"
...
{
return_type RacecarGazeboHardware::configure(
  const hardware_interface::HardwareInfo & info)
{
  ...
  for (const hardware_interface::ComponentInfo & joint : info_.joints)
  {
    ...
    {
      RCLCPP_FATAL(
        rclcpp::get_logger("RacecarGazeboHardware"),
...
RacecarGazeboHardware::export_state_interfaces()
{
...
RacecarGazeboHardware::export_command_interfaces()
{
...
return_type RacecarGazeboHardware::prepare_command_mode_switch(
...
return_type RacecarGazeboHardware::start()
{
  RCLCPP_INFO(
    rclcpp::get_logger("RacecarGazeboHardware"), "Starting... please wait...");

  for (int i = 0; i <= hw_start_sec_; i++)
  {
    rclcpp::sleep_for(std::chrono::seconds(1));
    RCLCPP_INFO(
      rclcpp::get_logger("RacecarGazeboHardware"), "%.1f seconds left...",
      hw_start_sec_ - i);
  }
  ...
  RCLCPP_INFO(
    rclcpp::get_logger("RacecarGazeboHardware"), "System successfully started! %u",
    control_lvl_[0]);
  return return_type::OK;
}

return_type RacecarGazeboHardware::stop()
{
  RCLCPP_INFO(
    rclcpp::get_logger("RacecarGazeboHardware"), "Stopping... please wait...");
  ...
  RCLCPP_INFO(
    rclcpp::get_logger("RacecarGazeboHardware"), "System successfully stopped!");

  return return_type::OK;
}

return_type RacecarGazeboHardware::read()
{
  for (std::size_t i = 0; i < hw_positions_.size(); i++)
  {
...
return_type RacecarGazeboHardware::write()
{
  /*RCLCPP_INFO(
    rclcpp::get_logger("RacecarGazeboHardware"),
    "Writing...");*/
...
PLUGINLIB_EXPORT_CLASS(
  ros2_control_demo_hardware::RacecarGazeboHardware,
