...
#ifndef RACECAR_HARDWARE__RACECAR_GAZEBO_HPP
#define RACECAR_HARDWARE__RACECAR_GAZEBO_HPP
...
#include "racecar_hardware/visibility_control.h"

using hardware_interface::return_type;

namespace ros2_control_demo_hardware
{
class RacecarHardware
: public hardware_interface::BaseInterface<hardware_interface::SystemInterface>
{
public:
  RCLCPP_SHARED_PTR_DEFINITIONS(RacecarHardware);
...
#endif  // RACECAR_HARDWARE__RACECAR_GAZEBO_HPP