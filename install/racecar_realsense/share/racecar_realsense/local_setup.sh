...
: ${AMENT_CURRENT_PREFIX:="/workspace/racecar_project/racecar_gazebo/install/racecar_realsense"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/racecar_realsense/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/racecar_realsense/environment/path.sh"
